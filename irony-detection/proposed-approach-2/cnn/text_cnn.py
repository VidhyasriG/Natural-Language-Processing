...
This python script is used to creating the CNN architecture. It is used by train.py and eval.py
It creates the architecture as per the paper.
"""
...
class TextCNN(object):
    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        self.h_pool_flat = tf.reshape(self.h_pool, [-1, num_filters_total], name="fixed_feature")
